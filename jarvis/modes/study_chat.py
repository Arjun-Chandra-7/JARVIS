...
# The full brief, verbatim, as a markdown document somebody can open and edit a heading in —
# rather than a condensation of it, or a string literal buried in Python.
PROMPT_FILE = Path(__file__).with_name("exam_tutor_prompt.md")
